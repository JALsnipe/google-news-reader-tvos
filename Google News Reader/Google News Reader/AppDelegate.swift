...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationCachesDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "nyc.lieberman.Google_News_Reader" in the application's caches Application Support directory.
